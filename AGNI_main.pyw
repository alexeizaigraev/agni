...
Button(text="ВВОД", command=otbor_text, background = 'cyan').grid(row=0, column=10, sticky=W)
Button(text="ОБНОВИ", command=refresh_me, background = 'cyan').grid(row=0, column=10)
Button(text="ОЧИСТИ", command=clear_me, background = 'cyan').grid(row=0, column=10, sticky=E)
Button(text="ПАРТНЁР", command=refresh_lb_term, background = 'cyan').grid(row=0, column=1, sticky=W+E)
Button(text="ТЕРМИНАЛ", command=otbor_otbor, background = 'cyan').grid(row=0, column=4, sticky=W+E)
Button(text="", background = 'cyan').grid(row=0, column=6, sticky=W+E)
Button(text="СБОР РП", command=monitor_get_rp_all, background = 'cyan').grid(row=0, column=7, sticky=W+E)
